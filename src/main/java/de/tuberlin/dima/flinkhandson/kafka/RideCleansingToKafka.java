...
public class RideCleansingToKafka {
	...
	public static void main(String[] args) throws Exception {
		...
		TaxiRideSource source = new TaxiRideSource(input, maxEventDelay, servingSpeedFactor);
		DataStream<TaxiRide> rides = env.addSource(new TaxiRideSource(input, maxEventDelay, servingSpeedFactor));

		/*
		DataStream<TaxiRide> rides = env.fromElements(TaxiRide.fromString("936656,START,2013-01-01 00:00:00,1970-01-01 00:00:00,-73.9867,40.751236,-74.00318,40.72036,2"),
			TaxiRide.fromString("928769,START,2013-01-01 00:00:00,1970-01-01 00:00:00,-73.99078,40.76088,-73.954185,40.778847,1"));
			*/
