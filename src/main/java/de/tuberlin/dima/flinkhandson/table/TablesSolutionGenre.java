...
public class TablesSolutionGenre {
	...
	public static void main(String[] args) throws Exception {
		...
		Table movieAVG = joined.groupBy("movieId, title, genre")
				.select("title, rating.avg as averageRating, userId.count.cast(INT) as userRatingCount, genre")
				.filter("genre = 'Comedy'");
